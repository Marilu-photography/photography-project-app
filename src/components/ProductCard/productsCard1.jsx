...
<div className="card" style={{ width: '400px', height: '100%'}}>
  ...
  <div className="card-info">
    ...
    <p className="text-body text-truncate">{description}</p>
  </div>
  <div className="card-footer">
    <span className="text-title">{price} €</span>
    <Link className="btnDetails" to={`/products/${_id}`}> Details </Link>
      ...
      <div className="product text-center mb-5">
        <div className="position-relative mb-3">
          ...
          <Link
            ...
            to={`/products/${_id}`}
          >
            <img className="img-fluid w-100 card-img" src={image} alt="..." />
          </Link>
      ...
      <svg className="svg-icon" viewBox="0 0 20 20">
        ...
        <h6>
          ...
          <a
            ...
            href="https://demo.bootstrapious.com/boutique/2-0/detail.html"
          >
            {name}
          </a>
        </h6>
